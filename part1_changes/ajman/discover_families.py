...
# MAGIC %md
# MAGIC # Part 1 — Discover Pure change families (Ajman)
...
# MAGIC so the scope -> family mapping in
# MAGIC `part1_changes/cfgs/AJMAN_cfg_changes.py` (copied from HBKU as a
# MAGIC starting assumption) can be confirmed against Ajman's real Pure
# MAGIC instance instead of assumed.
# MAGIC
# MAGIC Run this once for Ajman to confirm the mapping; it is not part of the
# MAGIC regular pipeline and does not save anything.
